...
class WirelessTypes(object):
    ...
    range_1_35V_or_0to2026408518ohm = _mscl.WirelessTypes_range_1_35V_or_0to2026408518ohm
    range_1_25V_or_0to10000ohm = _mscl.WirelessTypes_range_1_25V_or_0to10000ohm
    range_625mV_or_0to2580ohm = _mscl.WirelessTypes_range_625mV_or_0to2580ohm
    range_312_5mV_or_0to1290ohm = _mscl.WirelessTypes_range_312_5mV_or_0to1290ohm
    range_156_25mV_or_0to645ohm = _mscl.WirelessTypes_range_156_25mV_or_0to645ohm
    range_78_125mV_or_0to322ohm = _mscl.WirelessTypes_range_78_125mV_or_0to322ohm
    range_39_0625mV_or_0to161ohm = _mscl.WirelessTypes_range_39_0625mV_or_0to161ohm
    range_19_5313mV_or_0to80ohm = _mscl.WirelessTypes_range_19_5313mV_or_0to80ohm
    ...
    sensorOutputMode_vibration = _mscl.WirelessTypes_sensorOutputMode_vibration
...
class InputRangeEntry(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    inputRange = _swig_property(_mscl.InputRangeEntry_inputRange_get, _mscl.InputRangeEntry_inputRange_set)
    hasGain = _swig_property(_mscl.InputRangeEntry_hasGain_get, _mscl.InputRangeEntry_hasGain_set)
    gain = _swig_property(_mscl.InputRangeEntry_gain_get, _mscl.InputRangeEntry_gain_set)

    def __init__(self, *args):
        this = _mscl.new_InputRangeEntry(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
InputRangeEntry_swigregister = _mscl.InputRangeEntry_swigregister
InputRangeEntry_swigregister(InputRangeEntry)
...
class TempSensorOptions(object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    Thermocouple = staticmethod(_mscl.TempSensorOptions_Thermocouple)
    RTD = staticmethod(_mscl.TempSensorOptions_RTD)
    Thermistor = staticmethod(_mscl.TempSensorOptions_Thermistor)
    ...
    __del__ = lambda self: None
TempSensorOptions_swigregister = _mscl.TempSensorOptions_swigregister
TempSensorOptions_swigregister(TempSensorOptions)

def TempSensorOptions_Thermocouple(thermocouple):
    return _mscl.TempSensorOptions_Thermocouple(thermocouple)
TempSensorOptions_Thermocouple = _mscl.TempSensorOptions_Thermocouple

def TempSensorOptions_RTD(wire, rtd):
    return _mscl.TempSensorOptions_RTD(wire, rtd)
TempSensorOptions_RTD = _mscl.TempSensorOptions_RTD

def TempSensorOptions_Thermistor(thermistor):
    return _mscl.TempSensorOptions_Thermistor(thermistor)
TempSensorOptions_Thermistor = _mscl.TempSensorOptions_Thermistor
...
class ShuntCalCmdInfo(object):
    ...
    excitationVoltage = _swig_property(_mscl.ShuntCalCmdInfo_excitationVoltage_get, _mscl.ShuntCalCmdInfo_excitationVoltage_set)
...
class NodeFeatures(object):
    ...
    def maxSampleRateForLowPassFilter(self, lowPassFilter, samplingMode, dataCollectionMethod, dataMode):
        return _mscl.NodeFeatures_maxSampleRateForLowPassFilter(self, lowPassFilter, samplingMode, dataCollectionMethod, dataMode)

    def maxFilterSettlingTime(self, rate):
        return _mscl.NodeFeatures_maxFilterSettlingTime(self, rate)

    def minLowPassFilter(self, rate):
        return _mscl.NodeFeatures_minLowPassFilter(self, rate)
...
class ZUPTSettingsData(object):
    ...
    def __init__(self, enable, threshold):
        this = _mscl.new_ZUPTSettingsData(enable, threshold)
        try:
            self.this.append(this)
        except:
            self.this = this
    enabled = _swig_property(_mscl.ZUPTSettingsData_enabled_get, _mscl.ZUPTSettingsData_enabled_set)
    threshold = _swig_property(_mscl.ZUPTSettingsData_threshold_get, _mscl.ZUPTSettingsData_threshold_set)
    __swig_destroy__ = _mscl.delete_ZUPTSettingsData
    __del__ = lambda self: None
ZUPTSettingsData_swigregister = _mscl.ZUPTSettingsData_swigregister
ZUPTSettingsData_swigregister(ZUPTSettingsData)
...
class GeographicSourceOptions(object):
    ...
    def __init__(self, *args):
        this = _mscl.new_GeographicSourceOptions(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    source = _swig_property(_mscl.GeographicSourceOptions_source_get, _mscl.GeographicSourceOptions_source_set)
    fixed = _swig_property(_mscl.GeographicSourceOptions_fixed_get, _mscl.GeographicSourceOptions_fixed_set)
    __swig_destroy__ = _mscl.delete_GeographicSourceOptions
    __del__ = lambda self: None
GeographicSourceOptions_swigregister = _mscl.GeographicSourceOptions_swigregister
GeographicSourceOptions_swigregister(GeographicSourceOptions)
...
class EstimationControlOptions(object):
    ...
    def __init__(self, *args):
        this = _mscl.new_EstimationControlOptions(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    enableGyroBiasEstimation = _swig_property(_mscl.EstimationControlOptions_enableGyroBiasEstimation_get, _mscl.EstimationControlOptions_enableGyroBiasEstimation_set)
    enableAccelBiasEstimation = _swig_property(_mscl.EstimationControlOptions_enableAccelBiasEstimation_get, _mscl.EstimationControlOptions_enableAccelBiasEstimation_set)
    enableGyroScaleFactorEstimation = _swig_property(_mscl.EstimationControlOptions_enableGyroScaleFactorEstimation_get, _mscl.EstimationControlOptions_enableGyroScaleFactorEstimation_set)
    enableAccelScaleFactorEstimation = _swig_property(_mscl.EstimationControlOptions_enableAccelScaleFactorEstimation_get, _mscl.EstimationControlOptions_enableAccelScaleFactorEstimation_set)
    enableGNSSAntennaOffsetEstimation = _swig_property(_mscl.EstimationControlOptions_enableGNSSAntennaOffsetEstimation_get, _mscl.EstimationControlOptions_enableGNSSAntennaOffsetEstimation_set)
    enableHardIronAutoCalibration = _swig_property(_mscl.EstimationControlOptions_enableHardIronAutoCalibration_get, _mscl.EstimationControlOptions_enableHardIronAutoCalibration_set)
    enableSoftIronAutoCalibration = _swig_property(_mscl.EstimationControlOptions_enableSoftIronAutoCalibration_get, _mscl.EstimationControlOptions_enableSoftIronAutoCalibration_set)
    __swig_destroy__ = _mscl.delete_EstimationControlOptions
    __del__ = lambda self: None
EstimationControlOptions_swigregister = _mscl.EstimationControlOptions_swigregister
EstimationControlOptions_swigregister(EstimationControlOptions)
...
class AdaptiveMeasurementData(object):
    ...
    def __init__(self):
        this = _mscl.new_AdaptiveMeasurementData()
        try:
            self.this.append(this)
        except:
            self.this = this
    mode = _swig_property(_mscl.AdaptiveMeasurementData_mode_get, _mscl.AdaptiveMeasurementData_mode_set)
    lowPassFilterCutoff = _swig_property(_mscl.AdaptiveMeasurementData_lowPassFilterCutoff_get, _mscl.AdaptiveMeasurementData_lowPassFilterCutoff_set)
    lowLimit = _swig_property(_mscl.AdaptiveMeasurementData_lowLimit_get, _mscl.AdaptiveMeasurementData_lowLimit_set)
    highLimit = _swig_property(_mscl.AdaptiveMeasurementData_highLimit_get, _mscl.AdaptiveMeasurementData_highLimit_set)
    lowLimitUncertainty = _swig_property(_mscl.AdaptiveMeasurementData_lowLimitUncertainty_get, _mscl.AdaptiveMeasurementData_lowLimitUncertainty_set)
    highLimitUncertainty = _swig_property(_mscl.AdaptiveMeasurementData_highLimitUncertainty_get, _mscl.AdaptiveMeasurementData_highLimitUncertainty_set)
    minUncertainty = _swig_property(_mscl.AdaptiveMeasurementData_minUncertainty_get, _mscl.AdaptiveMeasurementData_minUncertainty_set)
    __swig_destroy__ = _mscl.delete_AdaptiveMeasurementData
    __del__ = lambda self: None
AdaptiveMeasurementData_swigregister = _mscl.AdaptiveMeasurementData_swigregister
AdaptiveMeasurementData_swigregister(AdaptiveMeasurementData)
...
class Voltages(object):
    ...
    __del__ = lambda self: None
Voltages_swigregister = _mscl.Voltages_swigregister
Voltages_swigregister(Voltages)
...
class SensorOutputModes(object):
    ...
    def __init__(self, *args):
        this = _mscl.new_SensorOutputModes(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
SensorOutputModes_swigregister = _mscl.SensorOutputModes_swigregister
SensorOutputModes_swigregister(SensorOutputModes)
...
class HeadingUpdateOptionsList(object):
    ...
    def __init__(self, *args):
        this = _mscl.new_HeadingUpdateOptionsList(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
HeadingUpdateOptionsList_swigregister = _mscl.HeadingUpdateOptionsList_swigregister
HeadingUpdateOptionsList_swigregister(HeadingUpdateOptionsList)
...
class AdaptiveMeasurementModes(object):
    ...
    def __init__(self, *args):
        this = _mscl.new_AdaptiveMeasurementModes(*args)
        try:
            self.this.append(this)
        except:
            self.this = this
    ...
    __del__ = lambda self: None
AdaptiveMeasurementModes_swigregister = _mscl.AdaptiveMeasurementModes_swigregister
AdaptiveMeasurementModes_swigregister(AdaptiveMeasurementModes)
